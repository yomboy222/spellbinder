...
getLevelFunctions['goon-hut'] = function() {
    ...
    level.initialThings = [ ['hut','room1',40,81],['goon','room1',18,68],['portcullis','room1',81,68],['loot','room0',18,81],['oxen','room0',55,81],['tang','room2',40,81],['shifter','room2',81,68],['soiree','room3',40,81],['treasure','room3',60,81] ];
    ...
    level.rooms = {
        ...
        'room2': {
            ...
            passages: [ 
               ...
               new Passage(PassageTypes.INVISIBLE_HORIZONTAL, 'E',97, 77, 'room3', 10, 77, true, 50, 77, 'shifter', PASSAGE_STATE_BLOCKED, 73, 63)],
        },
        'room3': {
            boundaries: [],
            filledPolygons: [],
