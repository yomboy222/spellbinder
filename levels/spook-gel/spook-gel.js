...
levelList.push( { name:'spook-gel', difficulty:5 } );

getLevelFunctions['spook-gel'] = function() {
    ...
    level.initialThings = [ ['gel','room1',40,81],['spook','room1',81,70],['flash','room2',40,81],['couch','room2',79,75],['treasure','room3',40,81] ];
