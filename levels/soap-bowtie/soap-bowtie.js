...
levelList.push( { name:'harder soap-bowtie [requires undoing transformations!]', difficulty:7 } );

getLevelFunctions['harder soap-bowtie [requires undoing transformations!]'] = function() {
